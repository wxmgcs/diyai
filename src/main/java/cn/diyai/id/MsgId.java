...
public class MsgId implements Serializable {
    ...
    public MsgId(String msgIds) {
        ...
        setGateId(Integer.parseInt(msgIds.substring(10, 15)));
        setSequenceId(Integer.parseInt(msgIds.substring(15, 20)));
    }
    /**
     *
     * @param timeMillis
    ...
    public String toString() {
        //
        return String
                .format("%1$02d%2$02d%3$02d%4$02d%5$02d%6$05d%7$05d",
